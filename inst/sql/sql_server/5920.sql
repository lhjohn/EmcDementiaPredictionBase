...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (374888,380701,439727,374341,4140090,436092,372241,4043378)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (374888,380701,439727,374341,4140090,436092,372241,4043378)
  and c.invalid_reason is null
